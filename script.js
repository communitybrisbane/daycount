...
const translations = {
    ja: {
        ...
        aboutTitle: "課題解決のリーディングカンパニー",
        aboutSubtitle: "私たちは、高度なイノベーションと顧客課題の解決に情熱を持ち、社会に価値を提供します。私たちは、最先端の技術と知識を駆使し、常に革新的なアプローチを追求します。顧客の課題に対して独自の視点を持ち、最適なソリューションを提供することが使命です。",
    ...
    en: {
        ...
        aboutTitle: "Problem-Solving Leading Company",
        aboutSubtitle: "We are passionate about advanced innovation and solving customer problems, providing value to society. We use cutting-edge technology and knowledge to constantly pursue innovative approaches. We have unique perspectives on customer problems and strive to provide optimal solutions. Our mission is to create value by collaborating with the outside world.",
