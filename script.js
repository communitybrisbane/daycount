...
const translations = {
    ja: {
        ...
        introBody: "大学院を休学し、オーストラリアへ。そこでは、想像もしなかった出会いと挑戦が待っていました。これは、孤独なスタートから始まり、多くの仲間と共に「居場所」を作り上げ、自分だけの地図を描いた一年間の記録です。このページでは、Takuのワーホリ365日を時系列で追いながら、その時々の出来事を追体験し一緒に楽しんでください。",
    ...
    en: {
        ...
        introBody: "I took a leave of absence from graduate school and went to Australia. There, unexpected encounters and challenges awaited me. This is a record of one year, starting from a lonely beginning, creating a 'place to belong' with many friends, and drawing my own map. On this page, you can follow my 365-day working holiday journey chronologically and relive the events of those times. Please enjoy my game with me.",
